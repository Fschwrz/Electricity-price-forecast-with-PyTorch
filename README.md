...
In the future I will improve the model so it also uses weather forecast data. When the model performs well, I will put a .py file here so it can be used directly to get a forecast in a single step.
